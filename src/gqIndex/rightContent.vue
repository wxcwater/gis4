<template>
  <div class="rightPanelContainer">
        <div style="display:flex;align-items:center;">
            <p id = 'title' >引江济太工程</p>
            <span class="fa fa-arrow-circle-o-left"  aria-hidden="true" style="color:white;font-size:1.5rem;margin-top:1px;margin-left:51%"></span>
        </div>
...
<script>
import monitorPanel from './monitorPanelExp.vue'
